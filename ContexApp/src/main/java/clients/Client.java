    ...
    public void sendMessage(String message) throws JsonProcessingException {
        ...
        switch (arr[0]) {
            ...
            case "get_messages":
                ...
                MessagesDto com = new MessagesDto(Integer.parseInt(arr[1]), Integer.parseInt(arr[2]));
                json.setPayload(com);
                json.setToken(token);
                break;
            case "list":
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    Request json = mapper.readValue(message, Request.class);
                    ...
                    if (header.getTyp().equals("message")){
                        ...
                        Client.token = mapper.convertValue(json.getPayload(), String.class);
                    }
                } catch (IOException e) {
                    throw new IllegalStateException(e);
                }
